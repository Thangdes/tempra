...
export class MessageService {
    ...
    private loadMessages(): void {
        ...
        booking: {
            ...
            advance_notice: 'Booking requires at least {{hours}} hours advance notice',
        ...
        availability: {
            ...
            invalid_time_range: 'Invalid time range: start_time ({{startTime}}) must be before end_time ({{endTime}})',
            overlapping: 'Overlapping availability rule detected for day {{dayOfWeek}}',
            creation_failed: 'Failed to create availability rule: {{message}}',
            invalid_date_range: 'Invalid date range provided',
            user_not_available: 'User is not available at the requested time: {{datetime}}',
        ...
        booking: {
            ...
            link_slug_not_found: 'Không tìm thấy liên kết đặt lịch với slug {{slug}}',
        ...
        availability: {
            ...
            no_rules_found: 'Không tìm thấy quy tắc lịch trống cho người dùng {{userId}}',
            invalid_time_range: 'Khoảng thời gian không hợp lệ: start_time ({{startTime}}) phải trước end_time ({{endTime}})',
            overlapping: 'Phát hiện quy tắc lịch trống trùng lặp cho ngày {{dayOfWeek}}',
            creation_failed: 'Tạo quy tắc lịch trống thất bại: {{message}}',
            invalid_date_range: 'Khoảng ngày không hợp lệ',
            user_not_available: 'Người dùng không rảnh vào thời gian yêu cầu: {{datetime}}',
